...
if [ -z "$SESSKIT_REQ" ]; then
  ...
  SESSKIT_REQ="sesskit @ https://github.com/x0c/sesskit/releases/download/v0.1.5/sesskit-0.1.5-py3-none-any.whl#sha256=e6b7b8f6ac83c4d95df12d3027600de3ba86c272973b83a9e2d50f63f933ff3d"
fi
echo "正在安装依赖 sesskit ..."
