...
if [ -z "$SESSKIT_REQ" ]; then
  ...
  SESSKIT_REQ="sesskit @ https://github.com/x0c/sesskit/releases/download/v0.1.6/sesskit-0.1.6-py3-none-any.whl#sha256=dd1085ff187a5167ec1948ef21a89e6547fbc2856f40ed0ca04cc15ce6e89072"
fi
echo "正在安装依赖 sesskit ..."
